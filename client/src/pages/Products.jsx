  ...
  const updateProduct = async (code) => {
    try {
      const product = await axios.put(
        `http://localhost:4000/products/edit/${code}`
      );
    ...
    <div className="w-full">
      ...
      {showFrom && (
        <div className="w-full p-4">
          <ProductForm setShowFrom={setShowFrom} getProducts={getProducts} />
        </div>
      )}
      {!showFrom && (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex gap-2">
                      <button className="flex items-center justify-center w-full py-2 px-4 bg-gray-900 text-gray-100 rounded-lg hover:bg-gray-700 focus:outline-none">
